...
export const CONTENT_SETTING_DEFINITIONS: ContentSettingParagraphArgs[] = [
  ...
  },
  {
    ...
    description:
      'Location gives you the user the ability to decide whether a website should have information on your current location. Using the internet connection you are currently connected too to browse the internet, your location can be determined either through geolocation or GPS.\n\nWhy Enable? Websites may require your location information to improve their websites. For instance, a website may require your location to check the stock of a product at your closest shop relevant to you. \n\nWhy Disable?Less than honest websites may for instance collect this instance to not be used to improve your experience but to instead target ads specific to your location. Disable Location to prevent an untrustworthy website from knowing your location.',
  },
  {
    ...
    options: ['allow', 'block', 'ask'],
    description:
      "Camera gives you the user the ability to decide whether a website should have access to your device's camera.",
  },
  {
  ...
  },
  {
    ...
    hide: true,
    description:
      'Unsandboxed plugins are applications developed to modify your web experience that you are required to approve before the plugin runs. Unsandboxed plugins let you do things like stream video or install software.\n\nWhy Enable? Plugins may be required for a webpage to function correctly. Lots of online video games require unsandboxed plugins to function. If the website is trusted and has requested plugins to be enabled, consider enabling this.\n\nWhy Disable? Plugins give way to a potential security breach where specific programs are allowed to manipulate your experience or access your information on your browser. If you do not trust this website, consider disabling this function.',
  },
  {
